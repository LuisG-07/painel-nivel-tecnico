var UIModals = (function() {
  ...
  function openZendeskTickets(analyst, ticketData, onSave) {
    ...
    var _now   = new Date();
    var filterFrom = new Date(_now.getFullYear(), _now.getMonth(), 1);
    var filterTo   = new Date(_now.getFullYear(), _now.getMonth() + 1, 0);
    var _defaultFrom = toInputVal(filterFrom);
    var _defaultTo   = toInputVal(filterTo);
