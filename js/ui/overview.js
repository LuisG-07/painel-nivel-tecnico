var UIOverview = (function() {
  ...
  function render(state) {
    ...
    function zdNegTable(title, icon, label, rows, clickFn) {
      ...
      var t = '<div id="' + wrapId + '"><div class="sectitle" style="margin-top:0;min-height:42px;align-items:flex-start"><i class="ti ' + icon + '"></i> ' + title + help + '</div>' +
    ...
    var modTable = '<div id="' + modWrapId + '"><div class="sectitle" style="margin-top:0;min-height:42px;align-items:flex-start"><i class="ti ti-list-numbers"></i> Ranking de Categorias (técnico)</div>' +
